...
read -p "Please enter your server file name(which should be in the server vpn directory, gameVpn if by default, and stands for the server) [myServerFile]:" -i "myServerFile" -e ConnectTo
